...
public class Test {
	...
	Teacher teacher2 = new Teacher(003,"教师3","清源校区",'A');
	Teacher teacher3 = new Teacher(051,"教师5","康庄校区",'B');
	Teacher teacher4 = new Teacher(022,"教师0","康庄校区",'A');
	//课程 
	teacher1.setCourse("Java应用开发技术");
	teacher2.setCourse("大学英语");    
	teacher3.setCourse("中国哲学史");   
	teacher4.setCourse("金工实习");
	Courses course1 = new Courses(000,"Java应用开发技术","清源校区","周一 9:40","教101");
	Courses course2 = new Courses(001,"大学英语","清源校区","周四 7:50","图501");
	Courses course3 = new Courses(002,"中国哲学史","康庄校区","周六 19:50","教207");
	Courses course4 = new Courses(003,"金工实习1","康庄校区","时间待定","地点待定");
	...
	//学生登入,并选择为退课或者选课
	Student stu = new Student(2022310900,"学生1","清源校区",2,"数据科学与大数据技术");     //学生登入
	//开始退选课部分
	while (flag1) {
    	...
    	String str1 = choose1.next();              //把第一次键盘输入传递给str1
    	 ...
    	 case "1" :
    	 {
    		 ...
    		 if (scan.hasNext())
    		 {
    			 ...
    			 {
    			 	case "0" :
    			 		{if(course1.choice) {System.out.println("恭喜,选课成功.");stu.setCoursed("Java应用开发技术");
    			 	...
    			 	case "3" :
    			 	{
    			 		if(course4.choice) {System.out.println("恭喜,选课成功.");stu.setCoursed("金工实习");
    			 		loopMethod(stu);flag1 = false;
    			 	}
    			 		else
    			 			{System.out.println("无剩余课余量,选课失败!");flag1 = false;}}
